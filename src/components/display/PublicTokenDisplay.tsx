...
import { Clock, Tv, Users, ArrowRight } from 'lucide-react';
  ...
  const fetchCurrentTokens = async () => {
    try {
      ...
      if (data.success && Array.isArray(data.data)) {
        const organizedData = organizeTokensByDepartment(data.data);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-700 p-4 md:p-8">
      ...
      <div className="mb-8 text-center">
        ...
        {/* Last Updated */}
        <div className="flex items-center justify-center text-white/80 text-lg md:text-xl">
                ...
                <div key={division.id} className="mb-6 last:mb-0">
                  <div className="bg-gray-100 rounded-lg p-4 mb-3">
                    ...
                    {division.currentToken ? (
                      <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-4 mb-3 text-center">
